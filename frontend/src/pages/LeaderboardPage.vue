<template>
  <section class="leaderboard-page-figma">
    <div class="leaderboard-top-bar">
    ...
    <div
      ...
      :style="{ height: (2000 * figmaScale) + 'px' }"
    >
      <iframe
        class="figma-frame"
        src="/figma-leaderboard-page/index.html"
        title="Leaderboard page design"
